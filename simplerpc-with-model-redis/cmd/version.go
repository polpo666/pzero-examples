...
var versionCmd = &cobra.Command{
	Use:   "version",
	Short: "simplerpc-with-model-redis version",
	Long:  `simplerpc-with-model-redis version`,
...
func printVersion() {
	...
	versionBuffer.WriteString(fmt.Sprintf("simplerpc-with-model-redis version %s %s/%s\n", resolvedVersion, runtime.GOOS, runtime.GOARCH))
