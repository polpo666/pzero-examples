...
var versionCmd = &cobra.Command{
	Use:   "version",
	Short: "simpleapi-with-model-redis version",
	Long:  `simpleapi-with-model-redis version`,
...
func printVersion() {
	...
	versionBuffer.WriteString(fmt.Sprintf("simpleapi-with-model-redis version %s %s/%s\n", resolvedVersion, runtime.GOOS, runtime.GOARCH))
